...
var Utils = {
    ...
    */
     ...
     * @return 返回加密后的sig参数
     */
    getSig: function (requestParam, sk, feature, mode) {
        var sig = null;
        var requestArr = [];
     ...
     * @return 返回终点数组
     */
    getEndLocation: function (location) {
     ...
     * @return 返回的是距离，单位m
     */
    getDistance: function (latFrom, lngFrom, latTo, lngTo) {
     ...
     * 处理用户参数是否传入坐标进行不同的处理
     */
    locationProcess: function (param, locationsuccess, locationfail, locationcomplete) {
        var that = this;
...
var QQMapWX = /** @class */ (function () {
    ...
    QQMapWX.prototype.calculateDistance = function (options) {
        ...
        if (requestParam.mode == 'straight') {
            ...
            var locationsuccess_1 = function (result) {
            ...
            Utils.locationProcess(options, locationsuccess_1);
        }
    };
    ;
    /**
